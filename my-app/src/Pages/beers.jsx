...
import porterBeer from './Images/PorterBeer.jpeg';
import guinnessBeer from './Images/guinness.jpeg';
import ipa from './Images/IPA.jpeg';
import paleAle from './Images/Pale Ale.jpeg';
import brownAle from './Images/Brown Ale.jpeg';
import pilsner from './Images/Pilsner.jpeg';
import lager from './Images/Lagers.jpeg';
import sourBeer from './Images/Sour Beer.jpeg';
import belgianBeer from './Images/Belgian Beer.jpeg';
import belgianBeer2 from './Images/Belgian Beer.2.jpeg';
import amberAle from './Images/Amber Ale.jpeg';
import hefeweizenBeer from './Images/Hefeweizen.jpeg';
import saisonBeer from './Images/Saison Beer.jpeg';
import kolschBeer from './Images/Kolsch Beer.jpeg';
    ...
    <html>
      ...
      <body>
        ...
        <div class = "welcome-bg" style = {{height: 770}}>
          <div class = "page-title"><a id = "Porter" href={() => false}>{symbol} Porter {symbol}</a></div>
          <div class = "inner-bg" style = {{height: 650}}><p>&emsp;The porter beer was first concocted in the 1700s in London, England. It was a mixture of old, sour beer; new, brown ale; and mild beers. Today, English porters come in two styles: brown and robust. Brown porters are maltier beers that can come in flavors like bittersweet chocolate, caramel, or toffee. Robust porters are more intense because they use roasted and black patent malt. These two porters are the English's versions. Next comes the Baltic porter. This one is very similar to an English porter, but it has much higher ABV content because it has to withstand the journey across the Baltic Sea. Finally, the American porter comes to fruition. This porter was crafted from n inspiration from the English Porter. One type of American Porter is called the Imperial style, which uses smoked malts to one-up the Robust English Porter. The other American Porter style lies along the lines of craft beer, which consists of aggressive hops and malt complexity. </p></div>
            <img src = {porterBeer} alt = "Porter beer" class = "crop-pic" style = {{height: 425}}/>
        ...
        <div class = "welcome-bg" style = {{height: 640}}>
          <div class = "page-title"><a id = "Stout" href={() => false}>{symbol} Stout {symbol}</a></div>
          ...
          <img src = {guinnessBeer} alt = "Guinness" class = "crop-pic" style = {{position: "absolute", height: 350, marginTop: -20}}/>
        ...
        <div class = "welcome-bg" style = {{height:810}}>
          <div class = "page-title"><a id = "IPA" href={() => false}>{symbol} IPA {symbol}</a></div>
          ...
          <img src = {ipa} alt = "IPA" class = "crop-pic" style = {{height: 465}}/>
        ...
        <div class = "welcome-bg" style = {{height: 630}}>
          <div class = "page-title"><a id = "Pale Ale" href={() => false}>{symbol} Pale Ale {symbol}</a></div>
          ...
          <img src = {paleAle} alt = "Pale Ale" class = "crop-pic" style = {{height: 285}}/>
        ...
        <div class = "welcome-bg" style = {{height: 675}}>
          <div class = "page-title"><a id = "Brown Ale" href={() => false}>{symbol} Brown Ale {symbol}</a></div>
          ...
          <img src = {brownAle} alt = "Brown Ale" class = "crop-pic" style = {{height: 330}}/>
        ...
        <div class = "welcome-bg" style = {{height: 675}}>
          <div class = "page-title"><a id = "Pilsner" href={() => false}>{symbol} Pilsner {symbol}</a></div>
          ...
          <img src = {pilsner} alt = "Pilsner" class = "crop-pic" style = {{height: 330}}/>
          <div class = "additional-info" style = {{textAlign: "center", marginTop: 355}}><p style = {{textDecoration: "underline"}}>Commerical Examples</p>
        ...
        <div class = "welcome-bg" style = {{height: 455}}>
          <div class = "page-title"><a id = "Lager" href={() => false}>{symbol} American Lager {symbol}</a></div>
          ...
          <img src = {lager} alt = "Lager" class = "crop-pic" style = {{height: 200, marginTop: -20}}/>
        ...
        <div class = "welcome-bg" style = {{height: 545}}>
          <div class = "page-title"><a id = "Sour" href={() => false}>{symbol} Sour {symbol}</a></div>
          ...
          <img src = {sourBeer} alt = "Sour Beer" class = "crop-pic" style = {{height: 250}}/>
        ...
        <div class = "welcome-bg" style = {{height: 850}}>
          <div class = "page-title"><a id = "Belgian" href={() => false}>{symbol} Belgian {symbol}</a></div>
          ...
          <img src = {belgianBeer} alt = "Belgian Beer" class = "crop-pic" style = {{height: 250}}/>
          <img src = {belgianBeer2} alt = "Belgian Beer" class = "crop-pic" style = {{height: 250, marginTop: 270}}/>
        ...
        <div class = "welcome-bg" style = {{height: 495}}>
          <div class = "page-title"><a id = "Amber" href={() => false}>{symbol} Amber {symbol}</a></div>
          ...
          <img src = {amberAle} alt = "Amber Ale" class = "crop-pic" style = {{height: 200}}/>
        ...
        <div class = "welcome-bg">
          <div class = "page-title"><a id = "Hefeweizen" href={() => false}>{symbol} Hefeweizen {symbol}</a></div>
          ...
          <img src = {hefeweizenBeer} alt = "Hefeweizen" class = "crop-pic" style = {{height: 295}}/>
        ...
        <div class = "welcome-bg" style = {{height: 545}}>
          <div class = "page-title"><a id = "Saison" href={() => false}>{symbol} Saison {symbol}</a></div>
          ...
          <img src = {saisonBeer} alt = "Saison Beer" class = "crop-pic" style = {{height: 250}}/>
        ...
        <div class = "welcome-bg" style = {{height: 545}}>
          <div class = "page-title"><a id = "Kolsch" href={() => false}>{symbol} Kolsch {symbol}</a></div>
          ...
          <img src = {kolschBeer} alt = "Kolsch Beer" class = "crop-pic" style = {{height: 240}}/>
          <div class = "additional-info" style = {{textAlign: "center", marginTop: 275, height: 160}}><p style = {{textDecoration: "underline"}}>Commercial Examples</p>
